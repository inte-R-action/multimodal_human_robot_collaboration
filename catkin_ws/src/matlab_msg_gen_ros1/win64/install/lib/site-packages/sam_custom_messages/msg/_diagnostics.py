...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.diagnosticstatus.name = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.diagnosticstatus.message = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.diagnosticstatus.hardware_id = str[start:end].decode('utf-8')
      else:
