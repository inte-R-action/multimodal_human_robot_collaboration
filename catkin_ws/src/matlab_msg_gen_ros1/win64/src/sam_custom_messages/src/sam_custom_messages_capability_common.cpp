...
// Common copy functions for sam_custom_messages/capability
...
#endif //_MSC_VER
#include "ros/ros.h"
#include "sam_custom_messages/capability.h"
...
namespace capability {
  ...
  MDArray_T get_arr_std_msgs_Header(MDFactory_T& factory, const sam_custom_messages::capability::_header_type& val);
  ...
  MDArray_T get_arr_sam_custom_messages_Object(MDFactory_T& factory, const sam_custom_messages::capability::_object_type& val);
  void copy_from_arr_geometry_msgs_Pose(geometry_msgs::Pose& val, const matlab::data::StructArray& arr);
  MDArray_T get_arr_geometry_msgs_Pose(MDFactory_T& factory, const sam_custom_messages::capability::_pose_type& val);
  ...
  //----------------------------------------------------------------------------
  SAM_CUSTOM_MESSAGES_EXPORT void copy_from_arr(boost::shared_ptr<sam_custom_messages::capability>& msg, const matlab::data::StructArray arr) {
    try {
        //header
  ...
  //----------------------------------------------------------------------------
  SAM_CUSTOM_MESSAGES_EXPORT MDArray_T get_arr(MDFactory_T& factory, const boost::shared_ptr<const sam_custom_messages::capability>& msg) {
    auto outArray = factory.createStructArray({1,1},{"header","user_id","object","pose","type","info"});
    // header
