...
class diagnostics(genpy.Message):
  _md5sum = "166ea485f1a6548735c38b7c8eac661c"
...
"""
  __slots__ = ['header','user_id','diagnosticstatus']
  _slot_types = ['std_msgs/Header','int8','diagnostic_msgs/DiagnosticStatus']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,user_id,diagnosticstatus
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2b().pack(_x.user_id, _x.diagnosticstatus.level))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.user_id, _x.diagnosticstatus.level,) = _get_struct_2b().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
