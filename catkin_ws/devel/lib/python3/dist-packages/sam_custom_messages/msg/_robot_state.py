...
class robot_state(genpy.Message):
  _md5sum = "54fa26edcc33c4c2c9089df338171f57"
...
float64 w
"""
  __slots__ = ['header','user_id','jointstate','pose']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,user_id,jointstate,pose
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_b3I().pack(_x.user_id, _x.jointstate.header.seq, _x.jointstate.header.stamp.secs, _x.jointstate.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.user_id, _x.jointstate.header.seq, _x.jointstate.header.stamp.secs, _x.jointstate.header.stamp.nsecs,) = _get_struct_b3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
